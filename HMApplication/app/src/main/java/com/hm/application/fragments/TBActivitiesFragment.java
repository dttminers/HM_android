...
public class TBActivitiesFragment extends Fragment {

    private LinearLayout mLlMain;
    private NestedScrollView mNsvScroll;
    private ViewPager vp;

    public TBActivitiesFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_tbactivities, container, false);
    }

    @Override
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        super.onActivityCreated(savedInstanceState);
        mLlMain = getActivity().findViewById(R.id.llActivity);
        mNsvScroll = getActivity().findViewById(R.id.nsvActivity);
